...
import { ProductVariantValidator } from '../../v2/product/variant/product.variant.validator.js'
...
export class ProductValidator {
    ...
    static baseSchema = z.object({
        ...
        variants: z
            .array(
                ProductVariantValidator.baseSchema.omit({ product_id: true }),
                {
                    error: 'Please provide atleast one variant',
                }
            )
            .min(1, 'Please provide at least one variant'),
    })
