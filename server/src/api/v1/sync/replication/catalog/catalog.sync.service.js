...
import { ProductVariantSyncService } from './variants/product.variant.sync.service.js'
...
export class CatalogSyncService {
    static pull(collection, checkpoint, limit) {
        switch (collection) {
            ...
            case SyncCollections.PRODUCT_VARIANT:
                return ProductVariantSyncService.pull(checkpoint, limit)
    ...
    static push(collection, docs) {
        switch (collection) {
            ...
            case SyncCollections.PRODUCT_VARIANT:
                return ProductVariantSyncService.push(docs)
