...
export const getAll = async (req, res) => {
    const response = await ProductCategoryService.findMany()
...
export const getCategory = async (req, res) => {
    const response = await ProductCategoryService.findById(req.params.id)
    res.status(response.status).json({
        success: response.success,
        data: response.data,
        message: response.message,
...
export const updateCategory = async (req, res) => {
    const response = await ProductCategoryService.update(
        req.params.id,
        req.body
    )
    res.status(response.status).json({
